...
public class tc001_invalidSignup_without_AgreePolicy {
	...
	driver.findElement(By.id("input-confirm")).sendKeys("Robinson@1234");
	driver.findElement(By.xpath("//input[@type='submit']")).click();

WebElement m = driver.findElement(By.xpath("//*[@id=\"account-register\"]/div[1]"));
String act = m.getText();
System.out.println("Error message is "+ act);

	TakesScreenshot d=(TakesScreenshot) driver;
	File src = d.getScreenshotAs(OutputType.FILE);
	File des=new File("C:\\Users\\91830\\eclipse-workspace\\FleetStudio\\Screenshots\\TC001.png");
